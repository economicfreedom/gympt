...
//        String url = "https://www.youtube.com/results?search_query=%EC%9A%B4%EB%8F%99+%ED%95%A0%EB%96%84+%EB%93%A3%EA%B8%B0+%EC%A2%8B%EC%9D%80+%EC%9D%8C%EC%95%85";
        String url = "https://news.naver.com/main/main.naver?mode=LSD&mid=shm&sid1=100";
        ...
        try {
            ...
            Elements rank = document.getElementsByClass("sh_text_headline nclicks(cls_pol.clsart)");

            String text = rank.get(0).text();
